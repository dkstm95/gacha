...
Use when the user asks what to invest in without a specific asset or domain.

Workflow:

1. Confirm investment policy constraints if missing: horizon, risk tolerance, market access, currency, geography, excluded assets.
