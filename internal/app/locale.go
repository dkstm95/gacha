...
func englishText() uiText {
	return uiText{
		...
		Footer:           " /help  /settings  /theme  /quit   •   enter to run   •   /quit to exit",
		FooterShort:      " /help  /quit   •   enter run   •   /quit exit",
...
func koreanText() uiText {
	return uiText{
		...
		Footer:           " /help  /settings  /theme  /quit   •   enter 실행   •   /quit 종료",
		FooterShort:      " /help  /quit   •   enter 실행   •   /quit 종료",
